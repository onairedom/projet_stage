...
def creationPdf(subjects, secondWithCoeff, Weeks, fileTxt, fileT):
	...
	if os.path.exists('figure3.pdf') :
		...
		os.system('pdftk Resultat.pdf Recap.pdf cat output Recapitulatif.pdf')
		## Suppression pdf inutile
		os.system('rm -rf figure1.pdf figure2.pdf figure3.pdf Resultat.pdf Res.pdf Recap.pdf')
		
	else :	
		os.system('pdftk Res.pdf Recap.pdf cat output Recapitulatif.pdf')
		## Suppression pdf inutile
		os.system('rm -rf figure1.pdf figure2.pdf Res.pdf Recap.pdf')
...
##creation du texte pour
		...
		self.L4 = Label(self.fenetre, text = 'Nom des fichiers textes et PDF : Récapitulatif')
		self.L4.grid(row = 3)

		self.nameFile = 'Recapitulatif'
...
# if nbw == 0:
	...
	def openFiles(self):
		self.hist.set_output_file(self.nameFile)
		self.repondre()
